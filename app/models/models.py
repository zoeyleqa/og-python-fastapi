...
class Attendee(SQLModel, table=True):
  ...
  us_alien_registration_number: Optional[str] = Field(sa_column=Column("USAAlienRegNum"))

  alternative_passport_number: Optional[str] = Field(sa_column=Column("AltPassportNum"))
  alternative_passport_country: Optional[str] = Field(sa_column=Column("AltPassportCountry"))

  is_us_citizen: Optional[int] = Field(sa_column=Column("IsUSACitizen"))
  country_of_citizenship: Optional[str] = Field(sa_column=Column("CountryOfCitizenship"))
